...
📌 Project Overview
This project presents an interactive Food Delivery Analysis Dashboard built using Tableau. The dashboard analyzes food ordering data to uncover customer ordering patterns, delivery performance, and business insights.
